...
echo ""
echo "Logs:"
echo "  app:    $LOG_DIR/agent.log (rotating)"
echo "  stderr: $LOG_DIR/stderr.log (crashes)"
echo ""
echo "IMPORTANT — Grant this permission in System Settings > Privacy & Security:"
echo "  Automation: allow Python 3.14 to control Music.app"
echo ""
